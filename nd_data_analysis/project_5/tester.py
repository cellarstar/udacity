...
# -----------------------------------------------------------------------------
def do_PCA(features_train, features_test, n_pca_comps, do_perform_PCA):
...
def test_classifier(clf, dataset, feature_list, do_perform_PCA=False, pca_components=False, do_scaling=True, folds = 1000):
    ...
    for train_idx, test_idx in cv:
        ...
        if do_perform_PCA:
            features_train, features_test = \
                do_PCA(features_train, features_test, pca_components, do_perform_PCA)
